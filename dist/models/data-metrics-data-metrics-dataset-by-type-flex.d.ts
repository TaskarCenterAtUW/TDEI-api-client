 ...
 *
 * @export
 * @interface DataMetricsDataMetricsDatasetByTypeFlex
 */
export interface DataMetricsDataMetricsDatasetByTypeFlex {
    /**
     *
     * @type {number}
     * @memberof DataMetricsDataMetricsDatasetByTypeFlex
     */
