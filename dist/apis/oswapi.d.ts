...
export declare const OSWApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    datasetBbox: (tdei_record_id: string, bbox: Array<number>, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    datasetBboxDownload: (job_id: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    datasetFlatternById: (tdei_record_id: string, override?: boolean, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    datsetBboxStatus: (job_id: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getdatasetFlatternStatus: (job_id: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const OSWApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    datasetBbox(tdei_record_id: string, bbox: Array<number>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<string>>>;
    /**
     * Downloads the dataset generated by the job
     * @summary Downloads the dataset file
     * @param {string} job_id job_id for dataset bounding box request
     ...
     * @throws {RequiredError}
     */
    datasetBboxDownload(job_id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>>;
    /**
     * Flatterns an OSW dataset for provided tdei_record_id.
     * @summary Flatterns an OSW dataset
     * @param {string} tdei_record_id tdei_record_id for a file, represented as a uuid
     ...
     * @throws {RequiredError}
     */
    datasetFlatternById(tdei_record_id: string, override?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<string>>>;
    /**
     * Summary of the dataset bounding box request
     * @summary Fetch status of dataset bounding box request
     * @param {string} job_id job_id for dataset bounding box request
     ...
     * @throws {RequiredError}
     */
    datsetBboxStatus(job_id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<DatasetBboxStatus>>>;
    /**
     * Returns boolean true if the action is successful
     * @summary Invalidates the OSW record
     * @param {string} tdei_record_id tdei_record_id for a file, represented as a uuid
     ...
     * @throws {RequiredError}
     */
    getdatasetFlatternStatus(job_id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<FlatteningStatus>>>;
    /**
     * This endpoint returns a list of url to zipped geojson files with osw data that meet the specified criteria. Criteria that can be specified include: a dataset area (polygon), minimum confidence level and osw version.
     * @summary List osw files meeting criteria.
     * @param {Array<number>} [bbox] A bounding box which specifies the area to be searched. A bounding box is specified by a string providing the lat/lon coordinates of the corners of the bounding box. Coordinate should be specified as west, south, east, north.
...
export declare const OSWApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    datasetBbox(tdei_record_id: string, bbox: Array<number>, options?: AxiosRequestConfig): Promise<AxiosResponse<string>>;
    /**
     * Downloads the dataset generated by the job
     * @summary Downloads the dataset file
     * @param {string} job_id job_id for dataset bounding box request
     ...
     * @throws {RequiredError}
     */
    datasetBboxDownload(job_id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>>;
    /**
     * Flatterns an OSW dataset for provided tdei_record_id.
     * @summary Flatterns an OSW dataset
     * @param {string} tdei_record_id tdei_record_id for a file, represented as a uuid
     ...
     * @throws {RequiredError}
     */
    datasetFlatternById(tdei_record_id: string, override?: boolean, options?: AxiosRequestConfig): Promise<AxiosResponse<string>>;
    /**
     * Summary of the dataset bounding box request
     * @summary Fetch status of dataset bounding box request
     * @param {string} job_id job_id for dataset bounding box request
     ...
     * @throws {RequiredError}
     */
    datsetBboxStatus(job_id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<DatasetBboxStatus>>;
    /**
     * Returns boolean true if the action is successful
     * @summary Invalidates the OSW record
     * @param {string} tdei_record_id tdei_record_id for a file, represented as a uuid
     ...
     * @throws {RequiredError}
     */
    getdatasetFlatternStatus(job_id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<FlatteningStatus>>;
    /**
     * This endpoint returns a list of url to zipped geojson files with osw data that meet the specified criteria. Criteria that can be specified include: a dataset area (polygon), minimum confidence level and osw version.
     * @summary List osw files meeting criteria.
     * @param {Array<number>} [bbox] A bounding box which specifies the area to be searched. A bounding box is specified by a string providing the lat/lon coordinates of the corners of the bounding box. Coordinate should be specified as west, south, east, north.
