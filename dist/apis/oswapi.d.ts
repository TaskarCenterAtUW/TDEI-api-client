...
export declare const OSWApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    oswDatasetViewerFeedbacksDownload: (tdei_project_group_id: string, tdei_dataset_id?: string, from_date?: Date, to_date?: Date, status?: string, sort_by?: string, due_date?: string, sort_order?: string, page_no?: number, page_size?: number, format?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    oswSelfMerge: (body: OswSelfmergeBody, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const OSWApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    oswDatasetViewerFeedback(body: ProjectIdTdeiDatasetIdBody1, project_id: string, tdei_dataset_id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<number>>>;
    /**
     * API accepts array of feedbacks with status details to be updated. Returns response for each feedback update.
     * @summary API to update the feedbacks status details
     * @param {Array<ProjectIdTdeiDatasetIdBody>} body
     ...
     * @throws {RequiredError}
     */
    oswSelfMerge(body: OswSelfmergeBody, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<string>>>;
    /**
     * Performs a spatial join operation between two datasets within the TDEI system. It involves two datasets, target and source, specifying the spatial dimension entities of each to be joined, such as edges, nodes, zones, points, lines, or polygons. The join operation is guided by specified conditions that define how the geometries of the two datasets interact, typically involving spatial functions like intersections. Additionally, filters can be applied to both datasets to refine the data involved in the join. Aggregate functions are also defined to associate the attributes from source to target dataset entity.The geometry column for data elements is specified as `geometry_target` and `geometry_source`.Eg: Find all light poles in source dataset within 5 m of an edge in target dataset, and associate the attribute highway from source dataset with each edge in target dataset. The response includes a `job_id` for tracking the request.To check the request status, refer to the location header in the response, which provides the URL for the status API endpoint.
     * @summary Performs a spatial join operation between two datasets within the TDEI system.
     * @param {OswSpatialjoinBody} body
...
export declare const OSWApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    oswDatasetViewerFeedback(body: ProjectIdTdeiDatasetIdBody1, project_id: string, tdei_dataset_id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<number>>;
    /**
     * API accepts array of feedbacks with status details to be updated. Returns response for each feedback update.
     * @summary API to update the feedbacks status details
     * @param {Array<ProjectIdTdeiDatasetIdBody>} body
     ...
     * @throws {RequiredError}
     */
    oswDatasetViewerFeedbacksDownload(tdei_project_group_id: string, tdei_dataset_id?: string, from_date?: Date, to_date?: Date, status?: string, sort_by?: string, due_date?: string, sort_order?: string, page_no?: number, page_size?: number, format?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>>;
    /**
     * Retrieves the feedbacks summary. Response includes a summary of feedbacks such as total count, total overdue, and other relevant statistics.
     * @summary Retrieves the feedbacks summary.
     * @param {string} [tdei_project_group_id] ID of the project group.
     ...
     * @throws {RequiredError}
     */
    oswSelfMerge(body: OswSelfmergeBody, options?: AxiosRequestConfig): Promise<AxiosResponse<string>>;
    /**
     * Performs a spatial join operation between two datasets within the TDEI system. It involves two datasets, target and source, specifying the spatial dimension entities of each to be joined, such as edges, nodes, zones, points, lines, or polygons. The join operation is guided by specified conditions that define how the geometries of the two datasets interact, typically involving spatial functions like intersections. Additionally, filters can be applied to both datasets to refine the data involved in the join. Aggregate functions are also defined to associate the attributes from source to target dataset entity.The geometry column for data elements is specified as `geometry_target` and `geometry_source`.Eg: Find all light poles in source dataset within 5 m of an edge in target dataset, and associate the attribute highway from source dataset with each edge in target dataset. The response includes a `job_id` for tracking the request.To check the request status, refer to the location header in the response, which provides the URL for the status API endpoint.
     * @summary Performs a spatial join operation between two datasets within the TDEI system.
     * @param {OswSpatialjoinBody} body
