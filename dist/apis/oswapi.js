...
var OSWApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        oswDatasetViewerFeedbackStatusUpdate: function (body, project_id, tdei_dataset_id, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, accessToken, _a, query, key, key, headersFromBaseOptions, needsSerialization;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            // verify required parameter 'body' is not null or undefined
                            if (body === null || body === undefined) {
                                throw new base_1.RequiredError('body', 'Required parameter body was null or undefined when calling oswDatasetViewerFeedbackStatusUpdate.');
                            }
                            // verify required parameter 'project_id' is not null or undefined
                            if (project_id === null || project_id === undefined) {
                                throw new base_1.RequiredError('project_id', 'Required parameter project_id was null or undefined when calling oswDatasetViewerFeedbackStatusUpdate.');
                            }
                            // verify required parameter 'tdei_dataset_id' is not null or undefined
                            if (tdei_dataset_id === null || tdei_dataset_id === undefined) {
                                throw new base_1.RequiredError('tdei_dataset_id', 'Required parameter tdei_dataset_id was null or undefined when calling oswDatasetViewerFeedbackStatusUpdate.');
                            }
                            localVarPath = "/api/v1/osw/dataset-viewer/feedbacks/{project_id}/{tdei_dataset_id}"
                                .replace("{".concat("project_id", "}"), encodeURIComponent(String(project_id)))
                                .replace("{".concat("tdei_dataset_id", "}"), encodeURIComponent(String(tdei_dataset_id)));
         ...
         * @throws {RequiredError}
         */
        oswQualityReportGenerate: function (tdei_dataset_id, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, accessToken, _a, query, key, key, headersFromBaseOptions;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            // verify required parameter 'tdei_dataset_id' is not null or undefined
                            if (tdei_dataset_id === null || tdei_dataset_id === undefined) {
                                throw new base_1.RequiredError('tdei_dataset_id', 'Required parameter tdei_dataset_id was null or undefined when calling oswQualityReportGenerate.');
                            }
                            localVarPath = "/api/v1/osw/quality-report/{tdei_dataset_id}"
                                .replace("{".concat("tdei_dataset_id", "}"), encodeURIComponent(String(tdei_dataset_id)));
                            localVarUrlObj = new URL(localVarPath, 'https://example.com');
                            if (configuration) {
                                baseOptions = configuration.baseOptions;
         ...
         * @throws {RequiredError}
         */
        oswSelfMerge: function (body, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            // verify required parameter 'body' is not null or undefined
                            if (body === null || body === undefined) {
                                throw new base_1.RequiredError('body', 'Required parameter body was null or undefined when calling oswSelfMerge.');
                            }
                            localVarPath = "/api/v1/osw/self-merge";
                            localVarUrlObj = new URL(localVarPath, 'https://example.com');
                            if (configuration) {
                                baseOptions = configuration.baseOptions;
                            }
         ...
         * @throws {RequiredError}
         */
        sanitizeOswFileForm: function (dataset, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (dataset === null || dataset === undefined) {
                                throw new base_1.RequiredError('dataset', 'Required parameter dataset was null or undefined when calling sanitizeOswFileForm.');
                            }
                            localVarPath = "/api/v1/osw/sanitize";
                            localVarUrlObj = new URL(localVarPath, 'https://example.com');
                            if (configuration) {
                                baseOptions = configuration.baseOptions;
                            }
    ...
    return {
        ...
        oswDatasetViewerFeedbackStatusUpdate: function (body, project_id, tdei_dataset_id, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.OSWApiAxiosParamCreator)(configuration).oswDatasetViewerFeedbackStatusUpdate(body, project_id, tdei_dataset_id, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
        ...
        oswQualityReportGenerate: function (tdei_dataset_id, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.OSWApiAxiosParamCreator)(configuration).oswQualityReportGenerate(tdei_dataset_id, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
        ...
        oswSelfMerge: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.OSWApiAxiosParamCreator)(configuration).oswSelfMerge(body, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
        ...
        sanitizeOswFileForm: function (dataset, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.OSWApiAxiosParamCreator)(configuration).sanitizeOswFileForm(dataset, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
...
var OSWApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        oswDatasetViewerFeedbackStatusUpdate: function (body, project_id, tdei_dataset_id, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.OSWApiFp)(configuration).oswDatasetViewerFeedbackStatusUpdate(body, project_id, tdei_dataset_id, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        oswQualityReportGenerate: function (tdei_dataset_id, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.OSWApiFp)(configuration).oswQualityReportGenerate(tdei_dataset_id, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        oswSelfMerge: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.OSWApiFp)(configuration).oswSelfMerge(body, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        sanitizeOswFileForm: function (dataset, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.OSWApiFp)(configuration).sanitizeOswFileForm(dataset, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
...
var OSWApi = /** @class */ (function (_super) {
     ...
     * @memberof OSWApi
     */
    OSWApi.prototype.oswDatasetViewerFeedbackStatusUpdate = function (body, project_id, tdei_dataset_id, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.OSWApiFp)(this.configuration).oswDatasetViewerFeedbackStatusUpdate(body, project_id, tdei_dataset_id, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
     ...
     * @memberof OSWApi
     */
    OSWApi.prototype.oswQualityReportGenerate = function (tdei_dataset_id, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.OSWApiFp)(this.configuration).oswQualityReportGenerate(tdei_dataset_id, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
     ...
     * @memberof OSWApi
     */
    OSWApi.prototype.oswSelfMerge = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.OSWApiFp)(this.configuration).oswSelfMerge(body, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
     ...
     * @memberof OSWApi
     */
    OSWApi.prototype.sanitizeOswFileForm = function (dataset, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.OSWApiFp)(this.configuration).sanitizeOswFileForm(dataset, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
