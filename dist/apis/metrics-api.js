...
exports.MetricsApi = exports.MetricsApiFactory = exports.MetricsApiFp = exports.MetricsApiAxiosParamCreator = void 0;
/* tslint:disable */
/* eslint-disable */
/**
...
var MetricsApiAxiosParamCreator = function (configuration) {
    ...
    return {
        ...
        dataMetrics: function (options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            localVarPath = "/api/v1/data-metrics";
         ...
         * @throws {RequiredError}
         */
        systemMetrics: function (options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, localVarApiKeyValue, _a, accessToken, _b, query, key, key, headersFromBaseOptions;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            localVarPath = "/api/v1/system-metrics";
                            localVarUrlObj = new URL(localVarPath, 'https://example.com');
                            if (configuration) {
                                baseOptions = configuration.baseOptions;
                            }
    ...
    return {
        ...
        dataMetrics: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.MetricsApiAxiosParamCreator)(configuration).dataMetrics(options)];
                        case 1:
        ...
        systemMetrics: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.MetricsApiAxiosParamCreator)(configuration).systemMetrics(options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
...
var MetricsApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        dataMetrics: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.MetricsApiFp)(configuration).dataMetrics(options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        systemMetrics: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.MetricsApiFp)(configuration).systemMetrics(options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
...
var MetricsApi = /** @class */ (function (_super) {
     ...
     * @memberof MetricsApi
     */
    MetricsApi.prototype.dataMetrics = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * @memberof MetricsApi
     */
    MetricsApi.prototype.systemMetrics = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.MetricsApiFp)(this.configuration).systemMetrics(options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    return MetricsApi;
