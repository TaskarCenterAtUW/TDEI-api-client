    ...
    return {
        ...
        listPathwaysFiles: function (bbox, tdei_station_id, pathways_schema_version, date_time, tdei_project_group_id, tdei_record_id, page_no, page_size, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.GTFSPathwaysApiAxiosParamCreator(configuration).listPathwaysFiles(bbox, tdei_station_id, pathways_schema_version, date_time, tdei_project_group_id, tdei_record_id, page_no, page_size, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
        ...
        listStations: function (tdei_project_group_id, page_no, page_size, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.GTFSPathwaysApiAxiosParamCreator(configuration).listStations(tdei_project_group_id, page_no, page_size, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
...
exports.GTFSPathwaysApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        listPathwaysFiles: function (bbox, tdei_station_id, pathways_schema_version, date_time, tdei_project_group_id, tdei_record_id, page_no, page_size, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.GTFSPathwaysApiFp(configuration).listPathwaysFiles(bbox, tdei_station_id, pathways_schema_version, date_time, tdei_project_group_id, tdei_record_id, page_no, page_size, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        listStations: function (tdei_project_group_id, page_no, page_size, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.GTFSPathwaysApiFp(configuration).listStations(tdei_project_group_id, page_no, page_size, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
...
var GTFSPathwaysApi = /** @class */ (function (_super) {
    ...
    GTFSPathwaysApi.prototype.listPathwaysFiles = function (bbox, tdei_station_id, pathways_schema_version, date_time, tdei_project_group_id, tdei_record_id, page_no, page_size, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, exports.GTFSPathwaysApiFp(this.configuration).listPathwaysFiles(bbox, tdei_station_id, pathways_schema_version, date_time, tdei_project_group_id, tdei_record_id, page_no, page_size, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
    ...
    GTFSPathwaysApi.prototype.listStations = function (tdei_project_group_id, page_no, page_size, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, exports.GTFSPathwaysApiFp(this.configuration).listStations(tdei_project_group_id, page_no, page_size, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
