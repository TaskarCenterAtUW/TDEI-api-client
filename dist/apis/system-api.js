...
var SystemApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        systemCapabilities: function (options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            localVarPath = "/api/v1/system/capabilities";
        ...
        systemCapabilities: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.SystemApiAxiosParamCreator)(configuration).systemCapabilities(options)];
                        case 1:
...
var SystemApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        systemCapabilities: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.SystemApiFp)(configuration).systemCapabilities(options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
...
var SystemApi = /** @class */ (function (_super) {
     ...
     * @memberof SystemApi
     */
    SystemApi.prototype.systemCapabilities = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.SystemApiFp)(this.configuration).systemCapabilities(options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    return SystemApi;
