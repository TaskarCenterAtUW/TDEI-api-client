...
import { DatasetBboxStatus } from '../models';
import { FlatteningStatus } from '../models';
...
export const OSWApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        datasetBboxDownload: async (job_id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'job_id' is not null or undefined
            if (job_id === null || job_id === undefined) {
                throw new RequiredError('job_id','Required parameter job_id was null or undefined when calling datasetBboxDownload.');
            }
            const localVarPath = `/api/v1/osw/dataset-bbox/download/{job_id}`
        ...
        datasetFlatternById: async (tdei_record_id: string, override?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v1/osw/dataset-flattern/{tdei_record_id}`
         ...
         * @throws {RequiredError}
         */
        datsetBboxStatus: async (job_id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'job_id' is not null or undefined
            if (job_id === null || job_id === undefined) {
                throw new RequiredError('job_id','Required parameter job_id was null or undefined when calling datsetBboxStatus.');
            }
            const localVarPath = `/api/v1/osw/dataset-bbox/status/{job_id}`
                .replace(`{${"job_id"}}`, encodeURIComponent(String(job_id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getdatasetFlatternStatus: async (job_id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'job_id' is not null or undefined
            if (job_id === null || job_id === undefined) {
                throw new RequiredError('job_id','Required parameter job_id was null or undefined when calling getdatasetFlatternStatus.');
            }
            const localVarPath = `/api/v1/osw/dataset-flattern/status/{job_id}`
                .replace(`{${"job_id"}}`, encodeURIComponent(String(job_id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const OSWApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async datasetBboxDownload(job_id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await OSWApiAxiosParamCreator(configuration).datasetBboxDownload(job_id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async datsetBboxStatus(job_id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<DatasetBboxStatus>>> {
            const localVarAxiosArgs = await OSWApiAxiosParamCreator(configuration).datsetBboxStatus(job_id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getdatasetFlatternStatus(job_id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<FlatteningStatus>>> {
            const localVarAxiosArgs = await OSWApiAxiosParamCreator(configuration).getdatasetFlatternStatus(job_id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OSWApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async datasetBboxDownload(job_id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return OSWApiFp(configuration).datasetBboxDownload(job_id, options).then((request) => request(axios, basePath));
        },
        /**
         * Flatterns an OSW dataset for provided tdei_record_id.
         * @summary Flatterns an OSW dataset
         ...
         * @throws {RequiredError}
         */
        async datsetBboxStatus(job_id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<DatasetBboxStatus>> {
            return OSWApiFp(configuration).datsetBboxStatus(job_id, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns boolean true if the action is successful
         * @summary Invalidates the OSW record
         ...
         * @throws {RequiredError}
         */
        async getdatasetFlatternStatus(job_id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<FlatteningStatus>> {
            return OSWApiFp(configuration).getdatasetFlatternStatus(job_id, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint returns a list of url to zipped geojson files with osw data that meet the specified criteria. Criteria that can be specified include: a dataset area (polygon), minimum confidence level and osw version.
         * @summary List osw files meeting criteria.
...
export class OSWApi extends BaseAPI {
     ...
     * @memberof OSWApi
     */
    public async datasetBboxDownload(job_id: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return OSWApiFp(this.configuration).datasetBboxDownload(job_id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Flatterns an OSW dataset for provided tdei_record_id.
     * @summary Flatterns an OSW dataset
     ...
     * @memberof OSWApi
     */
    public async datsetBboxStatus(job_id: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<DatasetBboxStatus>> {
        return OSWApiFp(this.configuration).datsetBboxStatus(job_id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns boolean true if the action is successful
     * @summary Invalidates the OSW record
     ...
     * @memberof OSWApi
     */
    public async getdatasetFlatternStatus(job_id: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<FlatteningStatus>> {
        return OSWApiFp(this.configuration).getdatasetFlatternStatus(job_id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This endpoint returns a list of url to zipped geojson files with osw data that meet the specified criteria. Criteria that can be specified include: a dataset area (polygon), minimum confidence level and osw version.
     * @summary List osw files meeting criteria.
