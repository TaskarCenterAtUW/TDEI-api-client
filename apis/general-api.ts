...
export const GeneralApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOrganizations: async (pageNo?: number, pageSize?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const GeneralApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listOrganizations(pageNo?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<Organization>>>> {
            const localVarAxiosArgs = await GeneralApiAxiosParamCreator(configuration).listOrganizations(pageNo, pageSize, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async listStations(tdeiOrgId?: string, pageNo?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<Station>>>> {
            const localVarAxiosArgs = await GeneralApiAxiosParamCreator(configuration).listStations(tdeiOrgId, pageNo, pageSize, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const GeneralApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listOrganizations(pageNo?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<Organization>>> {
            return GeneralApiFp(configuration).listOrganizations(pageNo, pageSize, options).then((request) => request(axios, basePath));
        },
        /**
         * Path used to retrieve the list of stations with data in the TDEI system. Allows callers to get the tdei_station_id id for a station.  Returns the tdei_station_id and station information for all stations with data in the TDEI system.  If tdei_org_id param is specified, will return stations for that organization. 
         * @summary List Stations
        ...
        async listStations(tdeiOrgId?: string, pageNo?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<Station>>> {
            return GeneralApiFp(configuration).listStations(tdeiOrgId, pageNo, pageSize, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GeneralApi extends BaseAPI {
     ...
     * @memberof GeneralApi
     */
    public async listOrganizations(pageNo?: number, pageSize?: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<Organization>>> {
        return GeneralApiFp(this.configuration).listOrganizations(pageNo, pageSize, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Path used to retrieve the list of stations with data in the TDEI system. Allows callers to get the tdei_station_id id for a station.  Returns the tdei_station_id and station information for all stations with data in the TDEI system.  If tdei_org_id param is specified, will return stations for that organization. 
     * @summary List Stations
    ...
    public async listStations(tdeiOrgId?: string, pageNo?: number, pageSize?: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<Station>>> {
        return GeneralApiFp(this.configuration).listStations(tdeiOrgId, pageNo, pageSize, options).then((request) => request(this.axios, this.basePath));
    }
}
