 ...
 * 
 * @export
 * @interface SystemMetricsDatasetMetricsTotalUploads
 */
export interface SystemMetricsDatasetMetricsTotalUploads {
    /**
     * 
     * @type {number}
     * @memberof SystemMetricsDatasetMetricsTotalUploads
     */
    count: number;
    /**
     * 
