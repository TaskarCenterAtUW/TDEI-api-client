 ...
 * 
 * @export
 * @interface OswSelfmergeBody
 */
export interface OswSelfmergeBody {
    /**
     * Dataset id to self-merge
     * @type {string}
     * @memberof OswSelfmergeBody
     */
    tdei_dataset_id: string;
    /**
     * Proximity value to identify equivalent entities in meters. Default value is 0.5 meters.
     * @type {number}
     * @memberof OswSelfmergeBody
     */
    proximity?: number;
